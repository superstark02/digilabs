                ...
                <div className="container px-1 py-24 mx-auto">
                    <div className="container px-5 py-24">
                        <div className="flex flex-col text-center w-full mb-12">
                            <h1 className="sm:text-4xl text-6xl font-medium title-font text-gray-900">Supercharge your <br /> workflow to get started</h1>
                            <p className="lg:w-2/3 mx-auto leading-relaxed text-base mt-2" style={{ fontSize: "12px" }} >Orci molestie nam vulputate nunc habitant gravida. Interdum <br /> vitae vivamus ipsum aliquet consectetur aliquam.</p>
                        </div>
                    </div>
